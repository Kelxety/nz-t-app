...
async function main() {
  ...
  // const chargeslip = await prisma.permission.create({
  //   data: {
  //     menuName: 'Charge Slip',
  //     code: 'default:system:charge-slip',
  //     fatherId: roleManagement.id,
  //     orderNum: 4,
  //     path: '',
  //     menuType: 'F',
  ...
  const warehouseSupplyRoom = await prisma.scmWarehouse.create({
    data: {
      whName: 'Supply Room',
      whAcro: 'SR',
      state: 'Active',
