...
import { AccountService } from '@app/shared/data-access/api';
import { NzMessageService } from 'ng-zorro-antd/message';
import { Subject, takeUntil } from 'rxjs';
import { NzFormatEmitEvent } from 'ng-zorro-antd/tree';
import { NzContextMenuService, NzDropdownMenuComponent } from 'ng-zorro-antd/dropdown';
import { TmsAccountModalComponent } from '@app/shared/feature/tms-account-modal/tms-account-modal.component';
...
@Component({
  selector: 'app-tms-account',
  templateUrl: './tms-account.component.html',
  styleUrls: ['./tms-account.component.less'],
...
export class TmsAccountComponent {
    ...
    this.apiService.list({order: order, pagination: false}).subscribe({
      next: (res:any) => {
        ...
        list.map((x: any) => {
          ...
          this.database.push({
            name: `${x.accountCode} - ${x.accountTitle}`,
            key: x.id,
            parentId: tempParent
          })
        });
